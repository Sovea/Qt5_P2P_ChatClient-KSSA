...
static QString user_password; /*qint16 myport=24600;*/
static QStringList Friends_Ids;
static QString newfriend_id;
static int index_friend_item;
static QString LinkId;
static qint64 loadSize = 1024;
static QHostAddress server_ip;
      ...
      ui(new Ui::MainWindow)
{
    ...
    this->newmessage_bells = new QSound(":/src/sound/newmessage.wav");
...
void MainWindow::newConnect()
{
    ...
    qDebug() << "ListTcpsocket count：" << LinkInfo.ListTcpsocket.count();
...
void MainWindow::ReadMessages()
{
    ...
    else if (type == SelectFriend)
    {
        ...
        qDebug() << "target people detail: " << thisfriend.username << thisfriend.userid << thisfriend.useremail << thisfriend.url_headimg;
    ...
    else if (type == AddFriend)
    {
        ...
        {
            this->dialog_addfriend->ui->Resultlabel->setText("friend added！");
...
void MainWindow::ReadFriendsMessages()
{
    ...
    else if (type == emitFile)
    {
        ...
        qDebug() << "total size" << filemessage.totalsize;
        QString filepath = QDir::currentPath() + "/files/" + filemessage.filename;
        qDebug() << "file detail:" << filemessage.filename << filemessage.filesize << filemessage.filetype;
    ...
    else if (type == accessFile)
    {
        ...
        if (ifaccess == true)
        {
            if (this->bytestosend > 0)
            {
                ...
                {
                    this->newmessage_bells->play();
                    this->sendbar->ui->label_headtext->setText("sended！");
    ...
    else if (type == File)
    {
        ...
        {
            this->newmessage_bells->play();
            this->recvbar->ui->label_headtext->setText("accepted！");
            int indexDesBubbleWidget = this->stackwidget.userid.indexOf(LinkId);
...
void MainWindow::SendFriendsMessages()
{
    ...
    {
        qDebug() << "content can not be empty";
    }
    else
    {
        QByteArray data;
...
void MainWindow::TwoReadFriendsMessages()
{
    ...
    else if (type == emitFile)
    {
        ...
        this->tempP2P->flush();
        this->recvbar = new progressbar();
        this->recvbar->ui->label_headtext->setText("accepting...");
        this->recvbar->ui->progressBar->setOrientation(Qt::Horizontal);
        this->recvbar->ui->progressBar->setMinimum(0);
        this->recvbar->ui->progressBar->setMaximum(100);
        this->recvbar->ui->progressBar->setValue(0);
...
void MainWindow::contextMenuEvent(QContextMenuEvent *event)
{
    ...
    QAction *Menu_info = new QAction("detail", this);
    QAction *Menu_dele = new QAction("delete", this);
...
void MainWindow::add_one_friend()
{
    ...
    this->dialog_addfriend->setWindowTitle("add friend");
    this->dialog_addfriend->setWindowIcon(QIcon(":/src/image/KSSA_Icon.png"));
...
void MainWindow::select_the_file()
{
    ...
    if (!this->filePath.isEmpty())
    {
        ...
        this->sendbar->setWindowIcon(QIcon(QIcon(":/src/image/KSSA_Icon.png")));
        this->sendbar->setWindowTitle("File Trans");
